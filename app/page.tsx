...
const words = {
  en: {
    ...
    name: "Your name", contact: "Phone / Line", email: "Email address (optional)", stay: "Stay type", room: "Preferred room", chooseRoom: "Choose an available room", noRooms: "No rooms are currently available", arrival: "Expected arrival", note: "Anything we should know?", send: "Send inquiry", sent: "We'll contact you soon — thank you for your inquiry!", roomChanged: "is now occupied. We switched your selection to", chooseAnother: "is now occupied. Please choose another available room.", occupiedPick: "This room is occupied. Choose an available room to send an inquiry.", needAvailable: "Please select an available room before sending your inquiry.", tapAvailable: "Tap an available room to continue",
