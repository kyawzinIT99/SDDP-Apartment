...
const words = {
  en: {
    ...
    name: "Your name", contact: "Phone / Line", stay: "Stay type", room: "Preferred room", chooseRoom: "Choose an available room", noRooms: "No rooms are currently available", arrival: "Expected arrival", note: "Anything we should know?", send: "Send inquiry", sent: "Thank you — your inquiry is with the SDDP team.", roomChanged: "is now occupied. We switched your selection to", chooseAnother: "is now occupied. Please choose another available room.", occupiedPick: "This room is occupied. Choose an available room to send an inquiry.", needAvailable: "Please select an available room before sending your inquiry.", tapAvailable: "Tap an available room to continue",
  ...
  th: {
    ...
    name: "ชื่อของคุณ", contact: "โทรศัพท์ / Line", stay: "ประเภทการเข้าพัก", room: "ห้องที่ต้องการ", chooseRoom: "เลือกห้องว่าง", noRooms: "ขณะนี้ไม่มีห้องว่าง", arrival: "วันที่คาดว่าจะเข้าพัก", note: "รายละเอียดเพิ่มเติม", send: "ส่งคำถาม", sent: "ขอบคุณ ทีม SDDP ได้รับคำถามของคุณแล้ว", roomChanged: "มีผู้เข้าพักแล้ว เราเปลี่ยนห้องที่เลือกเป็น", chooseAnother: "มีผู้เข้าพักแล้ว กรุณาเลือกห้องว่างอื่น", occupiedPick: "ห้องนี้มีผู้เข้าพักแล้ว กรุณาเลือกห้องว่างเพื่อส่งคำถาม", needAvailable: "กรุณาเลือกห้องว่างก่อนส่งคำถาม", tapAvailable: "แตะห้องว่างเพื่อดำเนินการต่อ",
