  ...
  return <main className="admin-shell">
    ...
    <section className="admin-main">
      ...
      {tab === "content" && <form className="editor-grid" onSubmit={save}>
        ...
        <section className="editor-card"><div className="card-head"><div><span>CONTACT</span><h2>Guest contact</h2></div></div><label>Main phone<input value={settings.phonePrimary} onChange={(e) => field("phonePrimary", e.target.value)} /></label><label>Second phone<input value={settings.phoneSecondary} onChange={(e) => field("phoneSecondary", e.target.value)} /></label><label>WhatsApp<input value={settings.whatsapp} onChange={(e) => field("whatsapp", e.target.value)} /></label><label>Line ID<input value={settings.lineId} onChange={(e) => field("lineId", e.target.value)} /></label></section>
